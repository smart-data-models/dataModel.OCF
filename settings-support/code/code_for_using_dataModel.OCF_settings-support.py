...
dataModel = "settings-support"
subject = "dataModel.OCF"
rt = {'type': 'Property', 'value': ['oic.r.settings.support']}
attribute = "rt"
value = rt
...
remote-management = {'type': 'Property', 'value': True}
attribute = "remote-management"
value = remote-management
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

software-auto-update = {'type': 'Property', 'value': False}
attribute = "software-auto-update"
value = software-auto-update
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
