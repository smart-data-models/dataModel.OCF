...
class ImpactSensor(BaseModel):
    ...
    impactdirectionhorizontal: Optional[confloat(ge=0.0, le=360.0)] = Field(
        None,
    ...
    impactdirectionvertical: Optional[confloat(ge=0.0, le=360.0)] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be ImpactSensor'
    )
