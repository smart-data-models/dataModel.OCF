...
class Capacity(BaseModel):
    ...
    capacity: Optional[confloat(ge=0.0, gt=0.0)] = Field(
        None, description='The rated capacity for the Device'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be capacity'
    )
