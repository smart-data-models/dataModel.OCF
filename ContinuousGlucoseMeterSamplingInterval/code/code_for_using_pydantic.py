...
class Type6(Enum):
    ContinuousGlucoseMeterSamplingInterval = 'ContinuousGlucoseMeterSamplingInterval'


class ContinuousGlucoseMeterSamplingInterval(BaseModel):
    ...
    interval: Optional[confloat(ge=0.0)] = Field(
        None, description='This Property describes the Sampling interval in seconds'
    )
    location: Optional[
