...
class Ecomode(BaseModel):
    address: Optional[Address] = Field(None, description='The mailing address')
    adminforced: Optional[bool] = Field(
        None,
    ...
    modes: Optional[List[Mode]] = Field(
        None, description='The array of the currently active mode(s).'
    )
    ...
    supportedModes: Optional[List[SupportedMode]] = Field(
        None, description='The array of possible modes the device supports.'
    )
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be ecomode'
    )
