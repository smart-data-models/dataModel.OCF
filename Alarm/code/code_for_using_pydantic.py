...
class Alarm(BaseModel):
    ...
    alarmtype: Optional[Alarmtype] = Field(None, description='The Alarm Type')
    ...
    duration: Optional[confloat(ge=0.0)] = Field(
        None, description='This Property describes the alarm duration (seconds)'
    )
    id: Optional[
        Union[
            constr(
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be Alarm'
    )
