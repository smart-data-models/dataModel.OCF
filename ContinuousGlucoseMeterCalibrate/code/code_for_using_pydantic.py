...
class Type6(Enum):
    ContinuousGlucoseMeterCalibrate = 'ContinuousGlucoseMeterCalibrate'


class ContinuousGlucoseMeterCalibrate(BaseModel):
    Cstatus: Optional[bool] = Field(
        None, description='Sensor calibration required flag'
    )
    Cvalue: Optional[confloat(ge=0.0)] = Field(
        None,
