...
class RampTime(BaseModel):
    ...
    rampTime: Optional[float] = Field(
        None, description='The actual speed of changing between 2 dimming values'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be RampTime'
    )
