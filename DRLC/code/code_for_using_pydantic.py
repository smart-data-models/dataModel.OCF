...
class DRLC(BaseModel):
    DRType: Optional[float] = Field(
        None, description='The to be applied demand-response type'
    )
    ...
    drlevel: Optional[confloat(ge=0.0, le=3.0)] = Field(
        None,
    ...
    mandate: Optional[bool] = Field(
        None, description='Whether overriding the DR request by the consumer is allowed'
    )
    ...
    override: Optional[bool] = Field(
        None, description='Whether the consumer has overriden the application of DR'
    )
    owner: Optional[
        List[
            Union[
    ...
    start: Optional[AwareDatetime] = Field(
        None, description='The start time for the application of DR'
    )
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be DRLC'
    )
