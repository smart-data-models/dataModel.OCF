...
class QueueItem(BaseModel):
    status: Status = Field(..., description='The status of the queue item.')
    uri: AnyUrl = Field(
...
class PrintQueue(BaseModel):
    ...
    queue: Optional[List[QueueItem]] = Field(
        None, description='The array of queue items for the printer.'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be PrintQueue'
    )
