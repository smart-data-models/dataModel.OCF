...
modes = ['Mouth personal notice. Do lette', 'Lawyer situation single huge. Up simply fine itself themsel']
attribute = "modes"
value = modes
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

supportedModes = ['Decision already serious nature anyone peace ago. Baby but onto region.', 'Focus hotel smile record. Risk around dream second dream quality onto.']
