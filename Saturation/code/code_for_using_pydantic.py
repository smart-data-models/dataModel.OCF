...
class Saturation(BaseModel):
    ...
    colourSaturation: Optional[confloat(ge=0.0, le=100.0)] = Field(
        None, description='The colour saturation value.'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be Saturation'
    )
