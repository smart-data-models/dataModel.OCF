...
class UVRadiation(BaseModel):
    ...
    measurement: Optional[float] = Field(None, description='The measured UV Index.')
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be UVRadiation'
    )
