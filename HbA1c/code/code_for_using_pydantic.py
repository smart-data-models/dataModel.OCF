...
class HbA1c(BaseModel):
    ...
    hba1c: Optional[confloat(ge=0.0, le=100.0)] = Field(
        None, description='Current HbA1c measurement in percentage'
    )
    id: Optional[
        Union[
            constr(
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be HbA1c'
    )
