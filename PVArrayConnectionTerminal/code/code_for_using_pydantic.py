...
class Type6(Enum):
    PVArrayConnectionTerminal = 'PVArrayConnectionTerminal'


class PVArrayConnectionTerminal(BaseModel):
    ...
    arraycurrent: Optional[float] = Field(
        None, description='Output current of array in Ampere (A)'
    )
    arrayvoltage: Optional[float] = Field(
        None, description='Output voltage of array in volts (V)'
    )
    ...
    insulationresistance: Optional[float] = Field(
        None, description='Insulation resistance of circuit breaker (M Ohm)'
    )
    leakagecurrent: Optional[float] = Field(
        None, description='The leakage current in mA'
    )
    location: Optional[
    ...
    ratedarraycurrent: Optional[float] = Field(
        None,
    ...
    ratedarrayvoltage: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be PVArrayConnectionTerminal'
    )
