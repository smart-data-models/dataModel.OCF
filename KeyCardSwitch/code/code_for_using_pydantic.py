...
class Stateofcard(Enum):
    validCardInserted = 'validCardInserted'
    validCardNotInserted = 'validCardNotInserted'


class Type6(Enum):
    KeyCardSwitch = 'KeyCardSwitch'


class KeyCardSwitch(BaseModel):
    ...
    rt: Optional[List[RtEnum]] = Field(
        None, description='The Resource Type of KeyCardSwitch', min_length=1
    )
    ...
    stateofcard: Optional[Stateofcard] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be KeyCardSwitch'
    )
