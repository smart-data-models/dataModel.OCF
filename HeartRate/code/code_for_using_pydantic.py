...
class HeartRate(BaseModel):
    ...
    heartrate: Optional[confloat(ge=0.0)] = Field(
        None, description='This Property describes the heart rate in bpm'
    )
    id: Optional[
        Union[
            constr(
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be HeartRate'
    )
