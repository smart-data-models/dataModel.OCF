...
class Movement(BaseModel):
    ...
    movement: Optional[str] = Field(None, description='The current movement value.')
    movementModifier: Optional[str] = Field(
        None,
        description='The modifier to the movement value (e.g. spin-90, left-20), units are device dependent.',
    )
    movementSettings: Optional[List[str]] = Field(
        None, description='The array of possible movement values.'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be movement'
    )
