...
class Type6(Enum):
    ContinuousGlucoseMeterThreshold = 'ContinuousGlucoseMeterThreshold'


class ContinuousGlucoseMeterThreshold(BaseModel):
    ...
    phigh: Optional[confloat(ge=0.0)] = Field(
        None, description='This Property describes the Patient high threshold (mg/dL)'
    )
    plow: Optional[confloat(ge=0.0)] = Field(
        None, description='This Property describes the Patient low threshold (mg/dL)'
    )
