...
class BinarySwitch(BaseModel):
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be BinarySwitch'
    )
    value: Optional[bool] = Field(None, description='The status of the switch.')
