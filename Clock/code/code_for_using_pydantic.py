...
class Clock(BaseModel):
    ...
    countdown: Optional[confloat(ge=0.0)] = Field(
        None, description='The desired total seconds for countdown.'
    )
    ...
    datetime: Optional[AwareDatetime] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be Clock'
    )
