...
class Type6(Enum):
    MuscleOxygenSaturation = 'MuscleOxygenSaturation'


class MuscleOxygenSaturation(BaseModel):
    ...
    muscleoxygensaturation: Optional[confloat(ge=0.0, le=100.0)] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be MuscleOxygenSaturation'
    )
