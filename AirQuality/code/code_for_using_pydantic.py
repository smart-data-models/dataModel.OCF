...
class AirQuality(BaseModel):
    ...
    contaminanttype: Optional[Contaminanttype] = Field(
        None, description='The contaminant being measured'
    )
    contaminantvalue: Optional[float] = Field(
        None, description='The measured or qualitative value for the contaminant'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be AirQuality'
    )
