...
class Type6(Enum):
    pulsatilecharacteristic = 'pulsatilecharacteristic'


class Pulsatilecharacteristic(BaseModel):
    ...
    characteristic: Optional[confloat(ge=0.0, le=3.0)] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be pulsatilecharacteristic'
    )
