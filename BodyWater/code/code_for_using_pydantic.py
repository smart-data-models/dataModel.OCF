...
class BodyWater(BaseModel):
    ...
    bwater: Optional[confloat(ge=0.0)] = Field(None, description='Body water')
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be BodyWater'
    )
    units: Optional[Units] = Field('kg', description='Body water unit')
