...
class Samplelocation(Enum):
    finger = 'finger'
    ast = 'ast'
    earlobe = 'earlobe'
    ctrlsolution = 'ctrlsolution'
...
class GlucoseSampleLocation(BaseModel):
    ...
    samplelocation: Optional[Samplelocation] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be GlucoseSampleLocation'
    )
