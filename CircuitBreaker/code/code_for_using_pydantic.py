...
class CircuitBreaker(BaseModel):
    ...
    ratedbreakingcurrent: Optional[float] = Field(
        None,
        description='The rated breaking current in Ampere, defined at manufacturing time',
    )
    ratedcurrent: Optional[float] = Field(
        None, description='The rated current in Ampere, defined at manufacturing time'
    )
    ratedvoltage: Optional[float] = Field(
        None, description='The rated voltage in Volts, defined at manufacturing time'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be CircuitBreaker'
    )
