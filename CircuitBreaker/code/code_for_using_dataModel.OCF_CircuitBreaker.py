...
dataModel = "CircuitBreaker"
subject = "dataModel.OCF"
rt = {'type': 'Property', 'value': ['oic.r.circuitbreaker']}
attribute = "rt"
value = rt
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

status = "{'type': 'Property', 'value': 'trip'}"
attribute = "status"
value = status
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

ratedcurrent = {'type': 'Property', 'value': 867.5}
attribute = "ratedcurrent"
value = ratedcurrent
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

ratedbreakingcurrent = {'type': 'Property', 'value': 561.4}
attribute = "ratedbreakingcurrent"
