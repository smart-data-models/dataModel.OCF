...
class Inverter(BaseModel):
    ...
    inputcurrent: Optional[float] = Field(None, description='input current in Amperes')
    inputvoltage: Optional[float] = Field(None, description='input voltage in Volts')
    location: Optional[
    ...
    outputpower: Optional[float] = Field(None, description='output power in kW')
    owner: Optional[
        List[
            Union[
                constr(
    ...
    ratedpower: Optional[float] = Field(
        None, description='The rated power in kW, defined at manufacturing time'
    )
    refInverterDevice: Optional[str] = Field(
        None, description='Reference to the InverterDevice, and its static attributes.'
    )
    ...
    totalEnergy: Optional[float] = Field(None, description='Total acumulated energy')
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be Inverter'
    )
