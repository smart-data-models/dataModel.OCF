...
class TimePeriod(BaseModel):
    ...
    intervalsecond: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    repeat: Optional[confloat(ge=-1.0)] = Field(
        None, description='The number of times to repeat the time period'
    )
    ...
    startTime: Optional[AwareDatetime] = Field(
        None, description='The start time for the time period'
    )
    state: Optional[State] = Field(
        None, description='The current state of the time interval'
    )
    stopTime: Optional[AwareDatetime] = Field(
        None,
        description="The stop time for the time period, if present the Property 'interval' or 'intervalsecond' cannot be present",
    )
    triggertiming: Optional[Triggertiming] = Field(
        None, description='The desired timing to trigger an action execution'
    )
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be TimePeriod'
    )
