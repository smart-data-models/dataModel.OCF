...
class Type6(Enum):
    ContinuousGlucoseMeterSensor = 'ContinuousGlucoseMeterSensor'


class ContinuousGlucoseMeterSensor(BaseModel):
    ...
    runtime: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be ContinuousGlucoseMeterSensor'
    )
