...
class Type6(Enum):
    ContinuousGlucoseMeterStatus = 'ContinuousGlucoseMeterStatus'


class ContinuousGlucoseMeterStatus(BaseModel):
    ...
    cgmtype: Optional[Cgmtype] = Field(
        None, description='This Property describes the CGM measurement type'
    )
    ...
    gtrend: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    malfunction: Optional[bool] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be ContinuousGlucoseMeterStatus'
    )
