...
class SignalStrength(BaseModel):
    ...
    lqi: Optional[float] = Field(
        None, description='The current value of Link Quality Indicator.'
    )
    ...
    rssi: Optional[float] = Field(
        None, description='The current value of Received Signal Strength Indicator.'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be SignalStrength'
    )
