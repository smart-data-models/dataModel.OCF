...
class Glucose(BaseModel):
    ...
    glucose: Optional[confloat(ge=0.0)] = Field(
        None, description='A measurement of glucose concentration in the blood'
    )
    id: Optional[
        Union[
            constr(
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be Glucose'
    )
    units: Optional[Units] = Field('mg/dL', description='Glucose unit')
