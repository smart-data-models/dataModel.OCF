...
class SoundPressureLevel(BaseModel):
    ...
    sounddB: Optional[confloat(ge=0.0)] = Field(
        None, description='The sound pressure level in dB.'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be SoundPressureLevel'
    )
