...
class Valueconditional(BaseModel):
    ...
    maxnotifyperiod: Optional[confloat(ge=0.0)] = Field(
        None,
        description='The maximum elapsed time in ms before a notification must be sent',
    )
    minnotifyperiod: Optional[confloat(ge=0.0)] = Field(
        None, description='The minimum elapsed time in ms before a notification is sent'
    )
    ...
    threshold: Optional[confloat(ge=0.0)] = Field(
        None,
        description='The amount by which the measured value must change before a notification is sent',
    )
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be valueconditional'
    )
