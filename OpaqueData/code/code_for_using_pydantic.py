...
class OpaqueData(BaseModel):
    ...
    payload: Optional[str] = Field(
        None, description='This Property contains the opaque data'
    )
    ...
    size: Optional[float] = Field(
        None, description='The size in bytes of the decoded binary object'
    )
    ...
    system: Optional[str] = Field(
        None, description='The eco system that is using the payload'
    )
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be OpaqueData'
    )
