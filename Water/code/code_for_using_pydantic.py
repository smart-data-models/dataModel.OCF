...
class Water(BaseModel):
    ...
    measurement: Optional[float] = Field(
        None, description='Measured value for this sensor in units of litres/hr'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be Water'
    )
    value: Optional[bool] = Field(None, description='true = sensed, false = not sensed')
