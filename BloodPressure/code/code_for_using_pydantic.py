...
class BloodPressure(BaseModel):
    ...
    diastolic: Optional[confloat(ge=0.0)] = Field(
    ...
    map: Optional[confloat(ge=0.0)] = Field(
        None, description='Mean arterial pressure (MAP)'
    )
    ...
    systolic: Optional[confloat(ge=0.0)] = Field(
        None, description='Systolic blood pressure'
    )
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be BloodPressure'
    )
    units: Optional[Units] = Field('mmHg', description='Blood pressure unit')
