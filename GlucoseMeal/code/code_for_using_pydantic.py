...
class Type6(Enum):
    GlucoseMeal = 'GlucoseMeal'


class GlucoseMeal(BaseModel):
    ...
    meal: Optional[Meal] = Field(
        None, description='Time of day when the measurement is taken.'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be GlucoseMeal'
    )
