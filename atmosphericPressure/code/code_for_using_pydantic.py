...
class AtmosphericPressure(BaseModel):
    ...
    atmosphericPressure: Optional[float] = Field(
        None, description='The current atmospheric pressure in hPa'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be atmosphericPressure'
    )
