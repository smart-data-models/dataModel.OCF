...
class Height(BaseModel):
    ...
    height: Optional[confloat(ge=0.0)] = Field(None, description='Height of an object')
    id: Optional[
        Union[
            constr(
                pattern=r'^[\\w\\-\\.\\{\\}\\$\\+\\*\\[\\]`|~^@!, :\\\\]+$',
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be Height'
    )
    units: Optional[Units] = Field('m', description='Height unit')
