...
class Deodorization(BaseModel):
    ...
    currentstate: Optional[Currentstate] = Field(
        None, description='The current state of the Deodorization function.'
    )
    ...
    mode: Optional[Mode] = Field(
        None, description='The modes of the Deodorization function.'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be Deodorization'
    )
