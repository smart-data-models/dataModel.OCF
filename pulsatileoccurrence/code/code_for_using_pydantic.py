...
class Occurrence(Enum):
    BEAT = 'BEAT'
    BEAT_MAX_INRUSH = 'BEAT_MAX_INRUSH'
    NOS = 'NOS'
...
class Type6(Enum):
    pulsatileoccurrence = 'pulsatileoccurrence'


class Pulsatileoccurrence(BaseModel):
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be pulsatileoccurrence'
    )
