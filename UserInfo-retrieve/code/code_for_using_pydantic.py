...
class RtEnum(Enum):
    oic_r_userinfo = 'oic.r.userinfo'


class Type6(Enum):
    UserInfo_retrieve = 'UserInfo-retrieve'


class UserinfoRetrieve(BaseModel):
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be UserInfo-retrieve'
    )
