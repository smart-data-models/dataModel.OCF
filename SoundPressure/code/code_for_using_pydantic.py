...
class SoundPressure(BaseModel):
    ...
    soundpa: Optional[confloat(ge=0.0)] = Field(
        None, description='The sound pressure in pascal.'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be SoundPressure'
    )
