...
class Brewing(BaseModel):
    ...
    amountrequested: Optional[float] = Field(
        None, description='The amount requested in ml.'
    )
    ...
    strength: Optional[float] = Field(
        None, description='The strength of a brewed drink.'
    )
    strengthrange: Optional[List[int]] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be Brewing'
    )
