...
class Exercise(BaseModel):
    ...
    exercise: Optional[confloat(ge=0.0, le=100.0)] = Field(
        None, description='The level of exercise undertaken in percentage'
    )
    id: Optional[
        Union[
            constr(
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be Exercise'
    )
