...
class Smoke(BaseModel):
    ...
    measurement: Optional[float] = Field(
        None, description='Measured value for this sensor, this is a percentage'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be smoke'
    )
    value: Optional[bool] = Field(
        None, description='The smoke indicator, true = sensed, false = not sensed'
    )
