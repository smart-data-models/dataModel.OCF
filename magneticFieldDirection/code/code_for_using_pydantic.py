...
class MagneticFieldDirection(BaseModel):
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be magneticFieldDirection'
    )
    value: Optional[List[float]] = Field(
        None, description='The array containing Hx, Hy, Hz.', max_length=3, min_length=3
    )
