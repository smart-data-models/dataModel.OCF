...
class Weight(BaseModel):
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be Weight'
    )
    units: Optional[Units] = Field('kg', description='Weight unit')
    weight: Optional[confloat(ge=0.0)] = Field(None, description='Weight of an object')
