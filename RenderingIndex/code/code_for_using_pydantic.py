...
class RenderingIndex(BaseModel):
    ...
    cri: Optional[confloat(le=100.0)] = Field(
        None, description='The colour rendering index.'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be RenderingIndex'
    )
