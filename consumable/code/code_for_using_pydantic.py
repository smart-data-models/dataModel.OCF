...
class Consumable(BaseModel):
    ...
    orderpercentage: Optional[confloat(ge=0.0, le=100.0)] = Field(
        None,
    ...
    remaining: Optional[confloat(ge=0.0, le=100.0)] = Field(
        None, description='The percentage remaining lifespan.'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be consumable'
    )
    typeofconsumable: Optional[str] = Field(
        None, description='The thing that is being consumed.'
    )
