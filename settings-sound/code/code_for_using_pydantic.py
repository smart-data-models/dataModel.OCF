...
class SettingsSound(BaseModel):
    ...
    auto_volume: Optional[bool] = Field(
        None,
        alias='auto-volume',
    ...
    dolby_atmos_compatibility: Optional[bool] = Field(
        None,
        alias='dolby-atmos-compatibility',
    ...
    rt: Optional[List[RtEnum]] = Field(
        None, description='The Resource Type of Device Settings for sound', min_length=1
    )
    ...
    supported_sound_modes: Optional[List[str]] = Field(
        None,
        alias='supported-sound-modes',
    ...
    supported_speakers: Optional[List[str]] = Field(
        None,
        alias='supported-speakers',
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be settings-sound'
    )
