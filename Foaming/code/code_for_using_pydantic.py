...
class Foaming(BaseModel):
    ...
    foamstrength: Optional[float] = Field(
        None, description='The desired foaminess of the liquid'
    )
    id: Optional[
        Union[
            constr(
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be Foaming'
    )
